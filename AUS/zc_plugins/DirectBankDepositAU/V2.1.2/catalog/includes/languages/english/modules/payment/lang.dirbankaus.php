...
if (!defined('MODULE_PAYMENT_DIRBANKAUS_ADDRESS')) {define('MODULE_PAYMENT_DIRBANKAUS_ADDRESS', '');}
if (!defined('MODULE_PAYMENT_DIRBANKAUS_PAYABLE')) {define('MODULE_PAYMENT_DIRBANKAUS_PAYABLE', '');}
if (!defined('MODULE_PAYMENT_DIRBANKAUS_SWIFT')) {define('MODULE_PAYMENT_DIRBANKAUS_SWIFT', '');}
