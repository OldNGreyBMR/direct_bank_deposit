...
if (defined('MODULE_PAYMENT_DIRBANKZA_STATUS') &&
    ...
    $define['MODULE_PAYMENT_DIRBANKZA_TEXT_DESCRIPTION'] = 'Banking and Address details will also be sent to your email once the order is confirmed.<br>' .
		...
		"\nAccount Name:  " . defined('MODULE_PAYMENT_DIRBANKZA_ACCNAM') . 
		"\nAccount No.:   " . defined('MODULE_PAYMENT_DIRBANKZA_ACCNUM') .
        "\nBank Name:     " . defined('MODULE_PAYMENT_DIRBANKZA_BANKNAM') .
        "\nBranch Code:   " . defined('MODULE_PAYMENT_DIRBANKZA_BANKCODE') .
        "\nReference:      " . $ln ."-" . $id . "-%s" .
