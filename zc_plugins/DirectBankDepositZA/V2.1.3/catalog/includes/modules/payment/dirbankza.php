<?php
/**
 * Direct Bank Deposit - ZA payment module (dirbankza).
 *
 ...
 *
 * Derived from Auzbank of OZcommerce (birdbrain) via DIRBANKNZ
 * (Nigel Thomson, 2010, adjusted from Crystal Jones code).
...
if (!defined('VERSION_ZA')) { define('VERSION_ZA', '2.1.3');}
...
if (!defined('MODULE_PAYMENT_DIRBANKZA_TEXT_TITLE')) {
    $filename = "dirbankza.php";
...
// class constructor
    function __construct() {
      ...
      $this->description = 'V' . VERSION_ZA . ' ' . MODULE_PAYMENT_DIRBANKZA_TEXT_DESCRIPTION; // show version in admin panel
