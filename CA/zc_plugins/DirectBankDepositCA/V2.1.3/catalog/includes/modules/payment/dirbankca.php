<?php
/**
 * Direct Bank Deposit - CA payment module (dirbankca).
 *
 * @copyright Copyright 2003-2026 Zen Cart Development Team
 * Portions Copyright 2003 osCommerce
 * Modifications Copyright 2025-2026 BMH (OldNGrey)
 * @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
 * @version $Id: OldNGrey 2026 Aug 25 Modified in V2.1.4 $
 *
 * Derived from Auzbank of OZcommerce (birdbrain) via DIRBANKAUS (Crystal Jones, 2009).
 * V2.1.2  2025-02-26  updated for zc220, PHP 8.3 to PHP 8.5
 * V2.1.2a 2026-02-27
 * V2.1.4  2026-08-25  One-Page Checkout integration (bottom-instructions observer)
 */

declare(strict_types = 1);
if (!defined('VERSION_CA')) { define('VERSION_CA', '2.1.2a');}
