...
if (defined('MODULE_PAYMENT_DIRBANKUSA_STATUS') && 
    ...
    $define['MODULE_PAYMENT_DIRBANKUSA_TEXT_DESCRIPTION'] = 'Banking and Address details will also be sent to your email once the order is confirmed.<br>' . 
        ...
        "\nAccount No.:  "  . defined('MODULE_PAYMENT_DIRBANKUSA_ACCNUM') .
        "\nRouting Number:" . defined('MODULE_PAYMENT_DIRBANKUSA_ROUTING') .
        "\nAccount Name: "  . defined('MODULE_PAYMENT_DIRBANKUSA_ACCNAM') . 
        "\nBank Name:    "  . defined('MODULE_PAYMENT_DIRBANKUSA_BANKNAM') .
        "\nReference:    "  . $ln ."-" . $id . "-%s" .
  ...
  $define ['MODULE_PAYMENT_DIRBANKUSA_TEXT_EMAIL_FOOTER'] = "Please use the following details to transfer your total order value:\n\n" .
        "\nAccount No.:  "  . defined('ODULE_PAYMENT_DIRBANKUSA_ACCNUM') .
        "\nRouting Number:" . defined('ODULE_PAYMENT_DIRBANKUSA_ROUTING') .
        "\nAccount Name: "  . defined('ODULE_PAYMENT_DIRBANKUSA_ACCNAM') . 
        "\nBank Name:    "  . defined('ODULE_PAYMENT_DIRBANKUSA_BANKNAM') .
        "\nReference:    "  . $ln ."-" . $id . "-%s" .
