...
// BMH (OldNGrey) 2024-10-14 lang.dirbankuk.php for zc210
...
if (defined('MODULE_PAYMENT_DIRBANKUK_STATUS')) {
  ...
  $define['MODULE_PAYMENT_DIRBANKUK_TEXT_DESCRIPTION'] = '<br>Banking and Address details will also be sent to your email once the order is confirmed.<br>' .
